...
hashtag_list = ['programmer', 'computerscience', 'codinglife']

prev_user_list = [] # if it's the first time you run it, use this line and comment the two below
# prev_user_list = pd.read_csv('20200301-010722_users_followed_list.csv', delimiter=',').iloc[:,1:2]  # useful to build a user log
